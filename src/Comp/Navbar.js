          ...
          <Flex w="100%">
            <Link to="/">
              <Text
                ...
                bgClip="text"
                fontSize={isLargerThan1880 ? "4xl" : "3xl"}
           ...
           Find altenatives
            ...
            {check && (
              <Tooltip label="Star! on github">
                <a href="https://github.com/tewarig/torii/" target="_blank">
                  <IconButton
                    ml={2}
                    mr={1}
                    icon={<FaGithub />}
              ...
              {meow ? (
                <>
                  <Box mt="50%">
                    ...
                    <Box mt="50%">
                      <Text margin="5%">Powered by</Text>
                      <Link
                        to={{ pathname: "https://clerk.dev/" }}
                        target="_blank"
                      >
                ...
                <Box>
                  ...
                  <Link
                    to={{ pathname: "https://github.com/tewarig/torii/issues" }}
                    target="_blank"
                    onClick={onClose}
                  >
                    <Button ml="1%" mt="5%" width="100%">
                  ...
                  <Link
                    to={{ pathname: "https://github.com/tewarig/torii/" }}
                    target="_blank"
                    onClick={onClose}
                  >
                    <Button ml="1%" mt="5%" width="100%">
                  ...
                  <Link
                    to={{
                      pathname:
                        "https://blog.gauravtewari.xyz/introducing-torii-making-participation-to-open-source-easy-for-everyone",
                    }}
                    target="_blank"
                    onClick={onClose}
                  >
